...
switch($opcion){
    case 1: //alta
        $consulta = "INSERT INTO w_provision (id_obra,id_prov,fecha_provi,concepto_provi,monto_provi,saldo_provi,subtotal_provi,iva_provi,tipo_provi) 
        VALUES('$id_obra','$id_prov','$fecha','$descripcion','$monto','$monto','$subtotal','$iva','$tipo') ";
