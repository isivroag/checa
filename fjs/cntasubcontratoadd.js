$(document).ready(function () {
    ...
    function permisos() {
      ...
      if (tipousuario == 1) {
        ...
        columnas =
          "<div class='text-center'><div class='btn-group'>\
          <button class='btn btn-sm bg-purple btnExtra'  data-toggle='tooltip' data-placement='top' title='Editar'><i class='fas fa-expand-alt'></i></button>\
          </div></div>"
      }
      return columnas
    }
    ...
    window.location.href="cntaextrasub.php?id="+folio
    })
