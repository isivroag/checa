    ...
    if (tipousuario == 1) {
      columnas =
        "<div class='text-center'><div class='btn-group'>\
          <button class='btn btn-sm btn-success btnAgregar' data-toggle='tooltip' data-placement='top' title='Agregar a Reporte' ><i class='fa-solid fa-circle-check'></i></button>\
