  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header bg-gradient-green text-light">
        <h1 class="card-title mx-auto">PARTIDA DE COSTOS</h1>
      </div>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-green">
                        <h5 class="modal-title" id="exampleModalLabel">PARTIDA DE COSTO</h5>
                            ...
                            <input type="hidden" class="form-control" name="id" id="id" autocomplete="off" placeholder="">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group input-group-sm">
                                        <label for="nombre" class="col-form-label">Nombre Partida:</label>
...
<script src="fjs/cntapartidacto.js?v=<?php echo(rand()); ?>"></script>
