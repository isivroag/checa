...
if ($_SESSION['id_obra'] != null) {
    ...
    $consulta = "SELECT * FROM vgasto WHERE id_obra='$id_obra' and estado_gto=1 ORDER BY id_obra,id_prov,fecha_gto,folio_gto";
} else {
    $id_obra = null;
    $obra = null;
    $consulta = "SELECT * FROM vgasto WHERE estado_gto=1 ORDER BY id_obra,id_prov,fecha_gto,folio_gto";
}
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-green text-light">
                <h1 class="card-title mx-auto">GASTOS NO DEDUCIBLES</h1>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $dat['fecha_gto'] ?></td>
                                                <td><?php echo $dat['concepto_gto'] ?></td>
                                                <td class="text-right"><?php echo number_format($dat['monto_gto'], 2) ?></td>
                                                <td class="text-right"><?php echo number_format($dat['saldo_gto'], 2) ?></td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content w-auto">
                    <div class="modal-header bg-gradient-green">
                        <h5 class="modal-title" id="exampleModalLabel">ALTA DE GASTOS</h5>
...
<script src="fjs/cntagastos.js?v=<?php echo (rand()); ?>"></script>
