...
if (isset($_GET['id'])) {
    ...
    $consulta = "SELECT * FROM vsubcontrato where folio_sub='$id'";
    ...
    foreach ($data as $row) {
        $foliosub = $row['folio_sub'];
        $id_obra = $row['id_obra'];
        $obra = $row['corto_obra'];
        $proveedor = $row['razon_prov'];
        $clave = $row['clave_sub'];
        $desc_sub = $row['desc_sub'];
        $importe_origen = $row['importe_original'];
        $importe_add = $row['importe_add'];
        $importe_dec = $row['importe_dec'];
        $importe_sub = $row['monto_sub'];
    }


    $consulta = "SELECT * FROM w_extrasub where folio_sub='$foliosub' and estado_extra=1 order by id_extra";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute();
    $data = $resultado->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row justify-content-center ">
                    ...
                    <div class="col-sm-1">
                        <div class="form-group input-group-sm">
                            <label for="foliosub" class="col-form-label">FOLIO SUB:</label>

                            <input type="text" class="form-control" name="foliosub" id="foliosub" value="<?php echo $foliosub ?>" disabled>
                        </div>
                    </div>

                    <div class="col-sm-2">
                        <div class="form-group input-group-sm">
                            <label for="clave" class="col-form-label">CLAVE SUB:</label>
                ...
                <div class="row justify-content-center ">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group input-group-sm">
                            ...
                            <textarea rows="2" class="form-control" name="descripcion" id="descripcion" placeholder="CONCEPTO" disabled> <?php echo $desc_sub?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center mb-4">
                    ...
                    <div class="col-sm-2">
                        <label for="importe" class="col-form-label">IMPORTE SUBCONTRATO:</label>
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <i class="fas fa-dollar-sign"></i>
                            ...
                            <input type="text" class="form-control text-right bg-white" name="importe" id="importe" value="<?php echo number_format($importe_sub, 2) ?>" disabled>
                                ...
                                <div class="row justify-content-sm-center" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-4 ">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control text-right" name="importeobra" id="importeobra" value="<?php echo number_format($importe_sub, 2) ?>" onkeypress="return filterFloat(event,this);" disabled>
                                        </div>
                                    </div>
                                    <div class=" col-sm-4 ">
...
<script src="fjs/cntaextrasub.js?v=<?php echo (rand()); ?>"></script>
