...
if ($_SESSION['id_obra'] != null) {
    ...
    $consulta = "SELECT * FROM vreq WHERE id_obra='$id_obra' and estado_req=1 and generado=0 and terminado =1 ORDER BY id_obra,id_prov,fecha,folio_req";
} else {
    $id_obra = null;
    $obra = null;
