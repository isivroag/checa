...
if ($_SESSION['id_obra'] == null) {
    ...
    if (isset($_GET['id_obra'])) {
        ...
        //BUSCAR NOMBRE DE OBRA
        $consultanom = "SELECT * from vnomina where id_obra='$id_obra' order by id_nom";
                            ...
                            <section class="content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <button id="btnNuevo" type="button" class="btn bg-gradient-info btn-ms" data-toggle="modal"><i class="fas fa-plus-square text-light"></i><span class="text-light"> Nuevo</span></button>
                                            </div>
                                        </div>
                                        <br>
