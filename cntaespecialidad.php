...
$consulta = "SELECT * FROM especialidad WHERE estado_especialidad=1 ORDER BY id_especialidad";
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $dat['nom_especialidad'] ?></td>
                        <td></td>
                      </tr>
                    <?php
                    }
...
<script src="fjs/cntaespecialidad.js"></script>
